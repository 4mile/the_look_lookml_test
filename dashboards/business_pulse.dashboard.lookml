- dashboard: business_pulse
  ...
  - title: Percent of Cohort Still Active by Traffic Source
    ...
    explore: order_items
    type: looker_line
    fields: [order_items.months_time_since_signup, users.count, users.traffic_source]
    pivots: [users.traffic_source]
    filters:
      order_items.months_time_since_signup: "[0, 12]"
      users.created_month: 12 months
    sorts: [order_items.months_time_since_signup, users.age_tier__sort_, users.traffic_source]
    limit: 500
    column_limit: 50
