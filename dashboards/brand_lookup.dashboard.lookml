...
#     type: looker_line
#     fields: [order_items.months_time_since_signup, order_items_share_of_wallet.brand_share_of_wallet_within_company,
#       order_items_share_of_wallet.total_sale_price_brand_v2]
#     filters:
#       order_items.months_time_since_signup: "<=18"
#     sorts: [order_items.months_time_since_signup]
#     limit: 500
#     query_timezone: America/Los_Angeles
#     x_axis_gridlines: false
#     y_axis_gridlines: false
